...
const enToId: Record<string, string> = {
  ...
  "pin to quick access": "sematkan ke akses cepat",
  "remove from quick access": "hapus dari akses cepat",
  ...
  "inventory assets": "aset inventaris",
  "vm inventory": "inventaris vm",
  "inventory services": "inventaris layanan",
